controladdin YDFModelAddin
{
    ...
    procedure TrainModel(ComaSeparatedDataWithHeader: Text; Task: Text; OutputColumnLabel: Text); // Create and traina  model given input data, formated as csv file coma separated and with one header row indicating the name of columns, and the name of column the output shall be learned to.
